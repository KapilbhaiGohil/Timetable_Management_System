...
export default function RefactorBatchForm({batches,dayoptions,teacheroptions,classrooms}){
    return(
                ...
                <div className={"batch-table"}>
                    <table>
                        ...
                        <tr>
                            ...
                            <td className={"refactor-batch-btn"}><Button label={"Add Lecture"}></Button></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
